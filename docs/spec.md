...
### 6. 동영상(비디오) 자동 업로드 미지원

**문제**: 티스토리 글에 포함된 동영상(비디오) 파일은 워드프레스로 자동 업로드되지 않습니다.

**영향**:

- 글 본문에 포함된 동영상이 워드프레스로 함께 옮겨지지 않을 수 있음
- 마이그레이션 후 워드프레스에서 동영상을 별도로 다시 업로드/삽입해야 함

**이유**: 현재 스펙에서 동영상 파일 다운로드/업로드를 지원하지 않음
